...
const translations = {
  "zh-CN": {
    ...
    disclaimerBody: "本站歌词由用户根据公开资源整理贡献，版权归原作者及版权方所有。本站不主张对歌词内容拥有任何权利。若您是权利人并认为此处内容侵犯您的权益，请联系我们，我们会尽快移除。",
  ...
  "zh-TW": {
    ...
    disclaimerBody: "本站歌詞由使用者根據公開資源整理貢獻，版權歸原作者及版權方所有。本站不主張對歌詞內容擁有任何權利。若您是權利人並認為此處內容侵犯您的權益，請聯絡我們，我們會盡快移除。",
  ...
  en: {
    ...
    disclaimerBody: "Lyrics on this site are contributed by users from publicly available sources. All rights remain with the original authors and copyright holders. This site claims no rights over the lyrics. If you hold the rights to any content here and believe it infringes them, contact us and we will remove it promptly.",
